# `<RichTextInput>` for vn-kooch-react-admin

For editing HTML with [vn-kooch-react-admin](https://github.com/marmelab/vn-kooch-react-admin), use the `<RichTextInput>` component. It embarks [quill](http://quilljs.com/), a popular cross-platform Rich Text Editor.
...
```sh
npm install vn-kooch-input-rich-text --save-dev
```
