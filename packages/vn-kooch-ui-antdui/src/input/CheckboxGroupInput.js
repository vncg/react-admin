...
export class CheckboxGroupInput extends Component {
    ...
    render() {
        ...
        if (typeof meta === 'undefined') {
            throw new Error(
                "The CheckboxGroupInput component wasn't called within a redux-form <Field>. Did you decorate it and forget to add the addField prop to your component? See https://marmelab.com/vn-kooch-react-admin/Inputs.html#writing-your-own-input-component for details."
            );
        }
