...
import { getDefaultValues, translate, REDUX_FORM_NAME } from 'vn-kooch-core';
        ...
        return (
            ...
            >
                ...
                <CardContentInner>
                    ...
                    See https://github.com/marmelab/vn-kooch-react-admin/issues/1866 */}
                    {Children.map(
                        children,
                        (tab, index) =>
                            tab && (
                                ...
                                >
                                    {routeProps =>
                                        React.cloneElement(tab, {
                                             ...
                                             *
                                             * @ref https://github.com/marmelab/vn-kooch-react-admin/issues/1956
                                             */
