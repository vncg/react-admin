 ...
 *
 * Use it to merge translations from addons with the main vn-kooch-react-admin translations.
 *
 * @example
 *     import React from 'react';
 *     import { Admin, Resource, mergeTranslations } from 'vn-kooch-react-admin';
 *     import englishMessages from 'vn-kooch-language-english';
 *     import englishTreeMessages from 'vn-kooch-tree-language-english';
 *     const messages = {
