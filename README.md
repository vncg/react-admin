# vn-kooch-react-admin [![Build Status](https://travis-ci.org/marmelab/vn-kooch-react-admin.svg?branch=master)](https://travis-ci.org/marmelab/vn-kooch-react-admin)
...
[Demo](https://marmelab.com/vn-kooch-react-admin-demo/) - [Documentation](https://marmelab.com/vn-kooch-react-admin/) - [News](https://marmelab.com/en/blog/#vn-kooch-react-admin) - [Releases](https://github.com/marmelab/vn-kooch-react-admin/releases) - [Support](http://stackoverflow.com/questions/tagged/vn-kooch-react-admin)
...
* [master](https://github.com/marmelab/vn-kooch-react-admin/commits/master) - commits that will be included in the next _patch_ release

* [next](https://github.com/marmelab/vn-kooch-react-admin/commits/next) - commits that will be included in the next _major_ or _minor_ release
...
#or
yarn add vn-kooch-react-admin
```

## Upgrading From Admin-On-Rest

Head to the [Upgrade Guide](https://github.com/marmelab/vn-kooch-react-admin/blob/master/UPGRADE.md).

## Documentation

Read the [Tutorial](http://marmelab.com/vn-kooch-react-admin/Tutorial.html) for a 15 minutes introduction. After that, head to the [Documentation](http://marmelab.com/vn-kooch-react-admin/index.html), or checkout the [source code of the demo](https://github.com/marmelab/vn-kooch-react-admin-demo) for an example usage.
...
![Data Provider architecture](https://marmelab.com/vn-kooch-react-admin/img/data-provider.png)

See the [Data Providers documentation](https://marmelab.com/vn-kooch-react-admin/DataProviders.html) for details.
...
```sh
# At the vn-kooch-react-admin project root
make install
...
$ cd ../myapp
$ npm link ../vn-kooch-react-admin/packages/vn-kooch-react-admin
